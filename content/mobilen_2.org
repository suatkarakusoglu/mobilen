...
Preference Key ile aşağıdan gelen veriyi [[https://github.com/aheze/SwipeActions/blob/main/Sources/SwipeActions.swift#L417][burada]] okuma:
#+INCLUDE: ./resources/OrgExportSettings/OrgExportLatexSourceBlock.org
#+begin_src swift
...
#+ATTR_LATEX: :width \textwidth
#+ATTR_HTML: :width 100%
[[file:resources/mobilen/dergi_2/vision_pro.jpg]]
...
#+ATTR_LATEX: :width \textwidth
#+ATTR_HTML: :width 100%
[[file:resources/mobilen/dergi_2/observable_macro.jpg]]
...
#+ATTR_LATEX: :width \textwidth
#+ATTR_HTML: :width 100%
[[file:resources/mobilen/dergi_2/macro_usage.jpg]]
...
[[file:resources/mobilen/dergi_2/SwiftData.jpg]]
...
* Xcodes: Xcode'un Sürümlerini Yönetmenin Etkin Yolu :Xcode:iOS:
...
#+ATTR_LATEX: :width 120px
#+ATTR_HTML: :width 100%
[[file:resources/mobilen/dergi_2/xcode_naming.jpeg]]
...
#+ATTR_LATEX: :width \textwidth
#+ATTR_HTML: :width 100%
[[file:resources/mobilen/dergi_2/xcodes_gui.jpg]]
...
#+ATTR_LATEX: :width \textwidth
#+ATTR_HTML: :width 100%
[[file:resources/mobilen/dergi_2/xcodes_terminal.jpg]]
